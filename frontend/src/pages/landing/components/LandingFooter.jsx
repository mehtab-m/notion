      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-lg text-brand-100">
            Join My Notion today and bring your notes, habits, and goals into one calm workspace.
          </p>
        ...
        <div className="mt-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-900">My Notion</span>
            </Link>
        ...
        <div className="mt-12 border-t border-gray-100 pt-8 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} My Notion. All rights reserved.
        </div>
      </div>
    </footer>
  );
